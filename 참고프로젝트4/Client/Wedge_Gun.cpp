...
IMPLEMENT_CREATE(CWedge_Gun)
IMPLEMENT_CLONE(CWedge_Gun, CGameObject)

CWedge_Gun::CWedge_Gun(ComPtr<ID3D11Device> pDevice, ComPtr<ID3D11DeviceContext> pContext)
    : BASE(pDevice, pContext)
{
}

CWedge_Gun::CWedge_Gun(const CWedge_Gun& rhs)
    : BASE(rhs)
{
}

HRESULT CWedge_Gun::Initialize_Prototype()
{
    return S_OK;
}

HRESULT CWedge_Gun::Initialize(void* pArg)
{
...
void CWedge_Gun::Begin_Play(_cref_time fTimeDelta)
{
...
void CWedge_Gun::Priority_Tick(_cref_time fTimeDelta)
{
    __super::Priority_Tick(fTimeDelta);
}

void CWedge_Gun::Tick(_cref_time fTimeDelta)
{
    __super::Tick(fTimeDelta);
}

void CWedge_Gun::Late_Tick(_cref_time fTimeDelta)
{
    __super::Late_Tick(fTimeDelta);
}

void CWedge_Gun::Before_Render(_cref_time fTimeDelta)
{
...
void CWedge_Gun::End_Play(_cref_time fTimeDelta)
{
    __super::End_Play(fTimeDelta);
}

HRESULT CWedge_Gun::Render()
{
    if (m_pModelCom)
    {
...
HRESULT CWedge_Gun::Ready_Components(void* pArg)
{
    ...
    if (m_pModelCom)
    {
        m_pModelCom->Link_Model(CCommonModelComp::TYPE_NONANIM, TEXT("Wedge_Gun"));
...
HRESULT CWedge_Gun::Bind_ShaderResources()
{
    // 공통 행렬 바인딩
...
void CWedge_Gun::OnCollision_Enter(CCollider* pThisCol, CCollider* pOtherCol)
{
}

void CWedge_Gun::OnCollision_Stay(CCollider* pThisCol, CCollider* pOtherCol)
{
}

void CWedge_Gun::OnCollision_Exit(CCollider* pThisCol, CCollider* pOtherCol)
{
}

void CWedge_Gun::PhysX_OnCollision_Enter(CPhysX_Collider* pThisCol, CPhysX_Collider* pOtherCol, const PxContactPair& ContactInfo)
{
}

void CWedge_Gun::PhysX_OnCollision_Stay(CPhysX_Collider* pThisCol, CPhysX_Collider* pOtherCol, const PxContactPair& ContactInfo)
{
}

void CWedge_Gun::PhysX_OnCollision_Exit(CPhysX_Collider* pThisCol, CPhysX_Collider* pOtherCol, const PxContactPair& ContactInfo)
{
}

void CWedge_Gun::Free()
{
    __super::Free();
}
