...
class CAirBurster_RightArm final : public CAirBurster_Parts
{
	INFO_CLASS(CAirBurster_RightArm, CAirBurster_Parts)

private:
	CAirBurster_RightArm(ComPtr<ID3D11Device> pDevice, ComPtr<ID3D11DeviceContext> pContext);
	CAirBurster_RightArm(const CAirBurster_RightArm& rhs);
	virtual ~CAirBurster_RightArm() = default;
...
public:
	static shared_ptr<CAirBurster_RightArm> Create(ComPtr<ID3D11Device> pDevice, ComPtr<ID3D11DeviceContext> pContext);
