...
IMPLEMENT_CREATE(CBiggs_Gun)
IMPLEMENT_CLONE(CBiggs_Gun, CGameObject)

CBiggs_Gun::CBiggs_Gun(ComPtr<ID3D11Device> pDevice, ComPtr<ID3D11DeviceContext> pContext)
    : BASE(pDevice, pContext)
{
}

CBiggs_Gun::CBiggs_Gun(const CBiggs_Gun& rhs)
    : BASE(rhs)
{
}

HRESULT CBiggs_Gun::Initialize_Prototype()
{
    return S_OK;
}

HRESULT CBiggs_Gun::Initialize(void* pArg)
{
...
void CBiggs_Gun::Begin_Play(_cref_time fTimeDelta)
{
...
void CBiggs_Gun::Priority_Tick(_cref_time fTimeDelta)
{
    __super::Priority_Tick(fTimeDelta);
}

void CBiggs_Gun::Tick(_cref_time fTimeDelta)
{
    __super::Tick(fTimeDelta);
}

void CBiggs_Gun::Late_Tick(_cref_time fTimeDelta)
{
    __super::Late_Tick(fTimeDelta);
}

void CBiggs_Gun::Before_Render(_cref_time fTimeDelta)
{
...
void CBiggs_Gun::End_Play(_cref_time fTimeDelta)
{
    __super::End_Play(fTimeDelta);
}

HRESULT CBiggs_Gun::Render()
{
    if (m_pModelCom)
    {
...
HRESULT CBiggs_Gun::Ready_Components(void* pArg)
{
    ...
    if (m_pModelCom)
    {
        m_pModelCom->Link_Model(CCommonModelComp::TYPE_NONANIM, TEXT("Biggs_Gun"));
...
HRESULT CBiggs_Gun::Bind_ShaderResources()
{
    // 공통 행렬 바인딩
...
void CBiggs_Gun::OnCollision_Enter(CCollider* pThisCol, CCollider* pOtherCol)
{
}

void CBiggs_Gun::OnCollision_Stay(CCollider* pThisCol, CCollider* pOtherCol)
{
}

void CBiggs_Gun::OnCollision_Exit(CCollider* pThisCol, CCollider* pOtherCol)
{
}

void CBiggs_Gun::PhysX_OnCollision_Enter(CPhysX_Collider* pThisCol, CPhysX_Collider* pOtherCol, const PxContactPair& ContactInfo)
{
}

void CBiggs_Gun::PhysX_OnCollision_Stay(CPhysX_Collider* pThisCol, CPhysX_Collider* pOtherCol, const PxContactPair& ContactInfo)
{
}

void CBiggs_Gun::PhysX_OnCollision_Exit(CPhysX_Collider* pThisCol, CPhysX_Collider* pOtherCol, const PxContactPair& ContactInfo)
{
}

void CBiggs_Gun::Free()
{
    __super::Free();
}
