...
CVIBuffer_Cell::CVIBuffer_Cell(ID3D11Device* pDevice, ID3D11DeviceContext* pContext, const _float3* pPoints)
...
HRESULT CVIBuffer_Cell::Initialize_Prototype()
{
	...
	memcpy(pVertices, m_vPoints, sizeof(VTXPOS) * 3);
...
{
	CVIBuffer_Cell* pInstance = new CVIBuffer_Cell(pDevice, pContext, pPoints);
