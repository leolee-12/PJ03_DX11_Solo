...
namespace Engine
{
	...
	WNAME_TAG(TARGET_COMBINED, L"Target_Combined");
	WNAME_TAG(TARGET_OUTLINEMASK, L"Target_OutLineMask");
	...
	WNAME_TAG(MRT_POSTPROCESS_IN, L"MRT_PostProcess_In");
	WNAME_TAG(MRT_OUTLINEMASK, L"MRT_OutlineMask");
