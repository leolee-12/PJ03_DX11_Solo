...
public:
	...
	static _float	Ease_Float(EASE eEase, _float elapsedTime, _float startValue, _float changeAmount, _float totalDuration);
	static _float2	Ease_Float2(EASE eEase, _float elapsedTime, _float2 startValue, _float2 changeAmount, _float totalDuration);
	static _float3	Ease_Float3(EASE eEase, _float elapsedTime, _float3 startValue, _float3 changeAmount, _float totalDuration);
	static _float4	Ease_Float4(EASE eEase, _float elapsedTime, _float4 startValue, _float4 changeAmount, _float totalDuration);
};
END
