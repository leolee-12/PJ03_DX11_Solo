...
{
	/*
	m_pGraphic_Device->SetStreamSource(0);
	m_pGraphic_Device->SetStreamSource(1);
	m_pGraphic_Device->SetStreamSource(2);
	
	m_pGraphic_Device->SetIndices();
	m_pGraphic_Device->SetFVF(D3DFVF_XYZ | D3DFVF_TEX1 | D3DFVF_tEXCOORDSIZE2(0));
	*/
