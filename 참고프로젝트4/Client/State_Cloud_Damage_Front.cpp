...
CState_Cloud_Damage_Front::CState_Cloud_Damage_Front(shared_ptr<class CGameObject> pActor, shared_ptr<class CStateMachine> pStatemachine)
	:CState_Cloud(pActor, pStatemachine)
{
}

HRESULT CState_Cloud_Damage_Front::Initialize_State(CState* pPreviousState)
{
	...
	case 5:
		...
		, 4, 1.f, 1.f, false);
	case 0:
		if (typeid(*pPreviousState) != typeid(CState_Cloud_Damage_Back) && pPreviousState != this)
...
void CState_Cloud_Damage_Front::Priority_Tick(_cref_time fTimeDelta)
{
...
void CState_Cloud_Damage_Front::Tick(_cref_time fTimeDelta)
{
	__super::Tick(fTimeDelta);
}

void CState_Cloud_Damage_Front::Late_Tick(_cref_time fTimeDelta)
{
	__super::Late_Tick(fTimeDelta);
}

void CState_Cloud_Damage_Front::Transition_State(CState* pNextState)
{
	__super::Transition_State(pNextState);
}

bool CState_Cloud_Damage_Front::isValid_NextState(CState* state)
{
	return true;
}

void CState_Cloud_Damage_Front::Free()
{
}
