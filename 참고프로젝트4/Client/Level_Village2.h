...
class CLevel_Village2 final : public CLevel
{
	INFO_CLASS(CLevel_Village2, CLevel)
private:
	CLevel_Village2(ComPtr<ID3D11Device> pDevice, ComPtr<ID3D11DeviceContext> pContext);
	virtual ~CLevel_Village2() = default;
...
public:
	static CLevel_Village2* Create(ComPtr<ID3D11Device> pDevice, ComPtr<ID3D11DeviceContext> pContext);
