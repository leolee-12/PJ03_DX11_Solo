...
CState_Cloud_Item_Potion::CState_Cloud_Item_Potion(shared_ptr<class CGameObject> pActor, shared_ptr<class CStateMachine> pStatemachine)
	:CState_Cloud(pActor, pStatemachine)
{
}

HRESULT CState_Cloud_Item_Potion::Initialize_State(CState* pPreviousState)
{
...
void CState_Cloud_Item_Potion::Priority_Tick(_cref_time fTimeDelta)
{
...
void CState_Cloud_Item_Potion::Tick(_cref_time fTimeDelta)
{
	__super::Tick(fTimeDelta);
}

void CState_Cloud_Item_Potion::Late_Tick(_cref_time fTimeDelta)
{
	__super::Late_Tick(fTimeDelta);
}

void CState_Cloud_Item_Potion::Transition_State(CState* pNextState)
{
	__super::Transition_State(pNextState);
}

bool CState_Cloud_Item_Potion::isValid_NextState(CState* state)
{
	return true;
}

void CState_Cloud_Item_Potion::Free()
{
}
