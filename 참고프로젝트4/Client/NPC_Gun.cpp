...
IMPLEMENT_CREATE(CNPC_Gun)
IMPLEMENT_CLONE(CNPC_Gun, CGameObject)

CNPC_Gun::CNPC_Gun(ComPtr<ID3D11Device> pDevice, ComPtr<ID3D11DeviceContext> pContext)
    : BASE(pDevice, pContext)
{
}

CNPC_Gun::CNPC_Gun(const CNPC_Gun& rhs)
    : BASE(rhs)
{
}

HRESULT CNPC_Gun::Initialize_Prototype()
{
    return S_OK;
}

HRESULT CNPC_Gun::Initialize(void* pArg)
{
...
void CNPC_Gun::Begin_Play(_cref_time fTimeDelta)
{
...
void CNPC_Gun::Priority_Tick(_cref_time fTimeDelta)
{
    __super::Priority_Tick(fTimeDelta);
}

void CNPC_Gun::Tick(_cref_time fTimeDelta)
{
    __super::Tick(fTimeDelta);
}

void CNPC_Gun::Late_Tick(_cref_time fTimeDelta)
{
    __super::Late_Tick(fTimeDelta);
}

void CNPC_Gun::Before_Render(_cref_time fTimeDelta)
{
...
void CNPC_Gun::End_Play(_cref_time fTimeDelta)
{
    __super::End_Play(fTimeDelta);
}

HRESULT CNPC_Gun::Render()
{
    if (m_pModelCom)
    {
...
HRESULT CNPC_Gun::Ready_Components(void* pArg)
{
    ...
    if (m_pModelCom)
    {
        m_pModelCom->Link_Model(CCommonModelComp::TYPE_NONANIM, TEXT("Npc_Gun"));
...
HRESULT CNPC_Gun::Bind_ShaderResources()
{
    // 공통 행렬 바인딩
...
void CNPC_Gun::OnCollision_Enter(CCollider* pThisCol, CCollider* pOtherCol)
{
}

void CNPC_Gun::OnCollision_Stay(CCollider* pThisCol, CCollider* pOtherCol)
{
}

void CNPC_Gun::OnCollision_Exit(CCollider* pThisCol, CCollider* pOtherCol)
{
}

void CNPC_Gun::PhysX_OnCollision_Enter(CPhysX_Collider* pThisCol, CPhysX_Collider* pOtherCol, const PxContactPair& ContactInfo)
{
}

void CNPC_Gun::PhysX_OnCollision_Stay(CPhysX_Collider* pThisCol, CPhysX_Collider* pOtherCol, const PxContactPair& ContactInfo)
{
}

void CNPC_Gun::PhysX_OnCollision_Exit(CPhysX_Collider* pThisCol, CPhysX_Collider* pOtherCol, const PxContactPair& ContactInfo)
{
}
