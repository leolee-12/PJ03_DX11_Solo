...
#pragma region VERTEX_BUFFER
    ...
    for (size_t i = 0; i < m_iNumVerticesZ; i++)
    {
        for (size_t j = 0; j < m_iNumVerticesX; j++)
        {
            ...
            pVertices[iIndex].vPosition = m_pVertexPositions[iIndex] = _float3(j, (pPixels[iIndex] & 0x000000ff) / 10.0f, i);
...
void CVIBuffer_Terrain::Culling(_fmatrix WorldMatrix)
{
    ...
    /*for (size_t i = 0; i < m_iNumVerticesZ - 1; i++)
    {
        for (size_t j = 0; j < m_iNumVerticesX - 1; j++)
        {
            ...
            _bool       isIn[4] = {
                m_pGameInstance->isIn_Frustum_LocalSpace(XMLoadFloat3(&m_pVertexPositions[iIndices[0]])),
                m_pGameInstance->isIn_Frustum_LocalSpace(XMLoadFloat3(&m_pVertexPositions[iIndices[1]])),
                m_pGameInstance->isIn_Frustum_LocalSpace(XMLoadFloat3(&m_pVertexPositions[iIndices[2]])),
                m_pGameInstance->isIn_Frustum_LocalSpace(XMLoadFloat3(&m_pVertexPositions[iIndices[3]])),
            };
