...
class CLevel_Village1 final : public CLevel
{
	INFO_CLASS(CLevel_Village1, CLevel)
private:
	CLevel_Village1(ComPtr<ID3D11Device> pDevice, ComPtr<ID3D11DeviceContext> pContext);
	virtual ~CLevel_Village1() = default;
...
public:
	static CLevel_Village1* Create(ComPtr<ID3D11Device> pDevice, ComPtr<ID3D11DeviceContext> pContext);
