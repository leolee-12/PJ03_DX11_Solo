...
CImgui_Window::CImgui_Window(vector< shared_ptr<CGameObject>>* pGameObjectList, ComPtr<ID3D11Device> pDevice, ComPtr<ID3D11DeviceContext> pContext)
	: m_pGameInstance(CGameInstance::GetInstance()),
	m_pContext(pContext), m_pDevice(pDevice), m_pImgui_Manger(CImgui_Manager::GetInstance())
{
...
void CImgui_Window::Tick(_cref_time fTimeDelta)
{
}

HRESULT CImgui_Window::Render()
{
	return S_OK;
}

void CImgui_Window::Use_ImGuizmo(shared_ptr<CGameObject> pGameObject, _bool bModel)
{
	/*==== GridMode ====*/
...
void CImgui_Window::Change_Value(string szName, _float fValue, _float* fOrigin)
{
	ImGui::SameLine();
