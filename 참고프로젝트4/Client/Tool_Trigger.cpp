...
IMPLEMENT_CREATE(CTool_Trigger)
IMPLEMENT_CLONE(CTool_Trigger, CGameObject)

CTool_Trigger::CTool_Trigger(ComPtr<ID3D11Device> pDevice, ComPtr<ID3D11DeviceContext> pContext)
	:CGameObject(pDevice, pContext)
{
}

CTool_Trigger::CTool_Trigger(const CTool_Trigger& rhs)
	:CGameObject(rhs)
{
}

HRESULT CTool_Trigger::Initialize_Prototype()
{
...
HRESULT CTool_Trigger::Initialize(void* pArg)
{
	...
	TRIGGERDESC* pDesc = (TRIGGERDESC*)pArg;
	m_szTrigger_Tag = pDesc->strName;
	m_eType = pDesc->eType;
...
void CTool_Trigger::Begin_Play(_cref_time fTimeDelta)
{
	__super::Begin_Play(fTimeDelta);

}

void CTool_Trigger::Priority_Tick(_cref_time fTimeDelta)
{
	__super::Priority_Tick(fTimeDelta);
}

void CTool_Trigger::Tick(_cref_time fTimeDelta)
{
...
void CTool_Trigger::Late_Tick(_cref_time fTimeDelta)
{
...
void CTool_Trigger::End_Play(_cref_time fTimeDelta)
{
	__super::End_Play(fTimeDelta);
}

HRESULT CTool_Trigger::Render()
{
	if (m_pModelCom)
	{
...
HRESULT CTool_Trigger::Ready_Components(void* pArg)
{
