...
enum class BATTLE_PHASE : _ubyte
{
	INTRO, INPUT_PLAYER, INPUT_OPPONENT,
	RESOLVE_ORDER, RESOLVE_ACTION_1, RESOLVE_ACTION_2, RESOLVE_END_TURN,
	CHECK_END, FORCED_SWITCH, OUTRO, DONE, END
};



enum class RENDER_RULE_KEY : _uint
{
	POKEMON_DEFAULT,
	MAP_DEFAULT,
	END
